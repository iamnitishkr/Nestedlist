...
import static com.iamnits.test.R.id.switcher;
...
public class MainListAdapter extends RecyclerView.Adapter<MainListAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public LinearLayout main_linear3_vert;
    ...
    public MainListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        viewHolder.main_linear3_vert = (LinearLayout) view.findViewById(R.id.main_linear3_vert);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(final MainListAdapter.ViewHolder holder, final int position) {
        ...
        if( list.getChain()!= null && list.getChain().size()>0){
            ...
            holder.main_linear3_vert.setOnClickListener(new View.OnClickListener() {
                @Override
